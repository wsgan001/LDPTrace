...
import utils
import experiment
from experiment import GridQuery
...
queries = [GridQuery(grid_map, round(args.grid_num / 3)) for _ in range(args.query_num)]

query_error = experiment.calculate_point_query(orig_grid_trajectories,
